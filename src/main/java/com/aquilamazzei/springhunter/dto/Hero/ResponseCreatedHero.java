...
public record ResponseCreatedHero(Long id, String peonName, Integer level, ClassNames classNames, Double damage, Double defense, Double life, Double experience, Boolean isAlive, Integer gold, Weapon weapon) {
}
